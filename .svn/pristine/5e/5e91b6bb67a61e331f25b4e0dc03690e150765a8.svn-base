...
import com.jhnu.util.login.CommonLoginUtil;
...
public class MyView extends InternalResourceView {
	...
	protected void exposeHelpers(HttpServletRequest request) throws Exception {
		...
		if (this.messageSource != null) {
			...
			BaseDao baseDao = (BaseDao) SpringContextUtil.getBean("baseDao", BaseDao.class);
			LoginResultBean jrb = CommonLoginUtil.checkUserName(username, baseDao.getJdbcTemplate());
			User user = (User)jrb.getObject();
			request.setAttribute("name", user.getReal_name());
