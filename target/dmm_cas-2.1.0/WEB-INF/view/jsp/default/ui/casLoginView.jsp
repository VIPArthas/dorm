...
<input type="hidden" name="autoType" value="<%=request.getParameter("autoType")%>" />
...
<div class="container"><header class="login-header login-mar-t50">
  ...
  <a class="login-header-infor" href="">统一身份认证平台</a>
...
<%--     <section class="row check">
    ...
    <section class=" btn-row">
     ...
     <% }else{%>
     <div class="text-right mt-20"><a href="${ctx}/retrievePwd.jsp" class="login-mh-enter">忘记密码 <span class="login-mh-icon"></span></a></div>
     <% }%>
...
<div class="login-footer">Copyright © 2010-2018 JingHua Normal University</div>
<%
}
%>
...
$(function(){
	...
	if(hasScrollbar()){
		...
		var loginDivHeight = $(".login-windows").outerHeight(true);
		var spaceHeight = (pageHeight-loginDivHeight)/2;     
		var top=$(".login-windows").offset().top; 
		window.scrollTo(0,top-spaceHeight-10);
	}
});
